...
// hàm lấy ID danh mục của sản phẩm theo ID sản phẩm
function get_iddm($id) {
    $sql = "SELECT iddm FROM product WHERE id=?";
    return pdo_query_value($sql, $id);
}
// hàm hiển thị số trang cho danh sách sản phẩm
...
// hàm lấy danh sách sản phẩm theo từ khóa, danh mục và phân trang
...
//ADMIN
// hàm hiển thị view danh sách sp
function showsp_admin($dssp){
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-1 col-sm-2 col-4 col-action text-end">
            ...
            <a onclick="return confirm(\'Bạn chắc chứ?\')" href="index.php?pg=delproduct&id='.$id.'" class="btn btn-sm font-sm btn-light rounded">
...
// hàm lấy danh sách sản phẩm trong admin theo từ khóa, danh mục và phân trang
...
// hàm lấy ảnh của sản phẩm theo ID
function get_img($id) {
