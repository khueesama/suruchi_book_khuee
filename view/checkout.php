                            ...
                            <td class="cart__table--body__list">
                                <div class="product__image two  d-flex align-items-center">
                                    ...
                                    <div class="product__description">
                                        <h3 class="product__description--name h4">'.$name. ' x'. $amount . '</h3>
                                    </div>
                                </div>
                            </td>
                            <td class="cart__table--body__list">
            ...
            <div class="checkout__page--inner d-flex">
                <div class="main checkout__mian">
                    ...
                    <footer class="main__footer checkout__footer">
                        <p class="copyright__content">© Copyright 2024 <a class="copyright__content--link text__primary" href="index.php">Suruchi</a></p>
                    </footer>
                </div>
