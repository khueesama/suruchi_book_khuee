        ...
        $html_cmt.= '<div class="swiper-slide">
                        <div class="testimonial__items text-center">
                            ...
                            <div class="testimonial__items--content">
                                ...
                                <span class="testimonial__items--subtitle">Happy Birthday</span>
            ...
            <div class="row mb--n28">
                <div class="col-lg-5 col-md-order mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" height="719px" src="https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2021/11/7/971682/Top-5-Cuon-Sach-Hay-.jpg" alt="banner-img">
                            <div class="banner__items--content">
                                <span class="banner__items--content__subtitle">Giỏ hàng</span>
                                <h2 class="banner__items--content__title h3">Sách hay mới nhất</h2>
                ...
                <div class="col-lg-7 mb-28">
                    <div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                        <div class="col mb-28">
                            <div class="banner__items">
                                <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" height="300px" src="https://vtv.gov.vn/uploads/ketnoi/321/vtvnet/2023/thang-8/thd.jpg" alt="banner-img"> 
                                    <div class="banner__items--content">
                                        <span class="banner__items--content__subtitle text__secondary">Sách Việt Nam</span>
                                        <h2 class="banner__items--content__title h3">Giảm đến 30% và <br/> miễn phí vận chuyển</h2>
                                        <span class="banner__items--content__link">Xem ngay
                                            <svg class="banner__items--content__arrow--icon" xmlns="http://www.w3.org/2000/svg" width="20.2" height="12.2" viewBox="0 0 6.2 6.2">
                                                <path d="M7.1,4l-.546.546L8.716,6.713H4v.775H8.716L6.554,9.654,7.1,10.2,9.233,8.067,10.2,7.1Z" transform="translate(-4 -4)" fill="currentColor"></path>
                                            </svg>
                        ...
                        <div class="col mb-28">
                            <div class="banner__items">
                                <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" height="300px" src="https://bizweb.dktcdn.net/100/363/455/files/trang-web-14.png?v=1697544634262" alt="banner-img"> 
                                    <div class="banner__items--content">
                                        <span class="banner__items--content__subtitle">Bánh sinh nhật dễ thương</span>
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="https://cdnphoto.dantri.com.vn/-y7D2Z9iYLqKVO9e1QRpXH7CHnY=/zoom/1200_630/2023/10/12/img5095-1697109683474.jpg" alt="banner-img"> 
                            <div class="banner__items--content">
                                <span class="banner__items--content__subtitle">Giảm giá 25%</span>
                                <h2 class="banner__items--content__title h3">Bánh sinh nhật<br/> tổng hợp</h2>
                                <span class="banner__items--content__link">Xem ngay
                                    <svg class="banner__items--content__arrow--icon" xmlns="http://www.w3.org/2000/svg" width="20.2" height="12.2" viewBox="0 0 6.2 6.2">
                                        <path d="M7.1,4l-.546.546L8.716,6.713H4v.775H8.716L6.554,9.654,7.1,10.2,9.233,8.067,10.2,7.1Z" transform="translate(-4 -4)" fill="currentColor"></path>
                                    </svg>
            ...
            <div class="row row-cols-md-2 row-cols-1 mb--n28">
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="https://curnonwatch.com/blog/wp-content/uploads/2022/07/Slide1-3.jpeg" alt="banner-img">
                            <div class="banner__items--content">
                ...
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="https://media.viez.vn/prod/2021/1/23/1611384975349_6611bfecd2.jpeg" alt="banner-img">
                            <div class="banner__items--content">
