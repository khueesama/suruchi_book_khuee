    ...
    switch ( $_GET[ 'pg' ] ) {
        case 'signin-signup':
            ...
            if ( isset( $_POST[ 'guiemail' ], $_POST[ 'fg_usr' ], $_POST[ 'fg_mail' ] ) ) {
                ...
                if ( $checkmail && is_array( $checkmail ) ) {
                    ...
                    $context = 'http://localhost:8888/suruchi_cake/index.php?pg=reset-pass&id='.$checkmail[ 'id' ];
                    $link_text = '<div style="border: 1px solid #dadce0;border-radius:8px;padding:20px 30px;width: 40%;margin: 0px auto;" align="center">
                                ...
                                <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:left">
                                    ...
                                    <a href="'.$context.'" style="display: block;width: 100px;margin: 0 auto;line-height: 30px;border-radius: 0.3rem;background: #1F509A;color: #fff;border: 0;text-align: center;text-decoration: none;margin-top: 20px;">TẠI ĐÂY</a>
                                </div>
                            </div>';
        ...
        case 'blog-detail':
            if ( isset( $_GET[ 'idblog' ] ) && ( $_GET[ 'idblog' ]>0 ) ) {
                ...
                $bloglienquan = get_tintuc_limit(4);
