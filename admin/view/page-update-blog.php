                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="title" id="title" cols="30" rows="10" class="form-control" required><?= $title ?></textarea>
                            <script>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" cols="30" rows="10" class="form-control form-control1" style="font-size: 17px;" required><?= $content ?></textarea>
                        </div>
                    </div>
                </div>
                <!-- card end// -->
